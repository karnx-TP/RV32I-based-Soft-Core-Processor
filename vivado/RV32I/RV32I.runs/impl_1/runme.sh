...
HD_PWD='C:/FPGA/RV32I-Processor/RV32I-based-Soft-Core-Processor/vivado/RV32I/RV32I.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rv32i_top_Soc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rv32i_top_Soc.tcl -notrace
